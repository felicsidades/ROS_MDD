...
public final class IInterface__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  private static void ___init___(@NotNull SNode __thisNode__) {
    if (!(SPropertyOperations.getBoolean(__thisNode__, PROPS.import$N7ax))) {
      ...
      ListSequence.fromList(SLinkOperations.getChildren(SNodeOperations.getNodeAncestor(__thisNode__, CONCEPTS.Node$iX, false, false), LINKS.dependencies$Dxgk)).addElement(dependency);
