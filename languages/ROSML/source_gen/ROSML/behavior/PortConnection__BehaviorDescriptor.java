...
public final class PortConnection__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0xf7db56d1b41e4c13L, 0x9756a014feb108beL, 0x52ae22b433653219L, "ROSML.structure.PortConnection");
  ...
  private static void ___init___(@NotNull SNode __thisNode__) {
    ...
    declaration.concat(SPropertyOperations.getString(SLinkOperations.getTarget(__thisNode__, LINKS.message$3geB), PROPS.package$uL2X));
    declaration.concat(SPropertyOperations.getEnum(SLinkOperations.getTarget(__thisNode__, LINKS.message$3geB), PROPS.message_type$93N4).toString());
    declaration.concat(SPropertyOperations.getString(SLinkOperations.getTarget(__thisNode__, LINKS.message$3geB), PROPS.name$MnvL));
    if (ListSequence.fromList(SLinkOperations.getChildren(SLinkOperations.getTarget(__thisNode__, LINKS.node$WQmF), LINKS.headers$h3Q7)).findFirst((it) -> SPropertyOperations.getString(it, PROPS.declaration$f54l) == declaration) == null) {
      ...
      ListSequence.fromList(SLinkOperations.getChildren(SLinkOperations.getTarget(__thisNode__, LINKS.node$WQmF), LINKS.headers$h3Q7)).addElement(nuevo);
    }
  }


  /*package*/ PortConnection__BehaviorDescriptor() {
  }
