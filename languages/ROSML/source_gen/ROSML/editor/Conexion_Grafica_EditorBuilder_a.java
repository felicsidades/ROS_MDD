...
/*package*/ class Conexion_Grafica_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public Conexion_Grafica_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createDiagramConnector_0(final EditorContext editorContext, final SNode node) {
    ...
    ContextVariables.withValue("thisNode", node, () -> {
      ...
      SNodeEdgeAccessor accessor = new SNodeEdgeAccessor(node) {
        ...
        private IConnectionEndpointReference endpointFrom = EndpointUtil.createEndpointReferenceForNodeSafe(SLinkOperations.getTarget(((SNode) _variablesContext.getValue("thisNode")), LINKS.productor$IXJD));
        private IConnectionEndpointReference endpointTo = EndpointUtil.createEndpointReferenceForNodeSafe(SLinkOperations.getTarget(((SNode) _variablesContext.getValue("thisNode")), LINKS.consumidor$IYsG));

        {
          ...
          if (reverse) {
            ...
            {
              Tuples._2<IConnectionEndpointReference, IConnectionEndpointReference> _tmp_8nxwpa_b0b0i0a0a1a2a3a8 = MultiTuple.<IConnectionEndpointReference,IConnectionEndpointReference>from(endpointTo, endpointFrom);
              endpointFrom = _tmp_8nxwpa_b0b0i0a0a1a2a3a8._0();
              endpointTo = _tmp_8nxwpa_b0b0i0a0a1a2a3a8._1();
            }
            {
              Tuples._2<EditorCell, EditorCell> _tmp_8nxwpa_c0b0i0a0a1a2a3a8 = MultiTuple.<EditorCell,EditorCell>from(endRoleCell, startRoleCell);
              startRoleCell = _tmp_8nxwpa_c0b0i0a0a1a2a3a8._0();
              endRoleCell = _tmp_8nxwpa_c0b0i0a0a1a2a3a8._1();
            }
            {
              Tuples._2<IShape, IShape> _tmp_8nxwpa_d0b0i0a0a1a2a3a8 = MultiTuple.<IShape,IShape>from(endShape, startShape);
              startShape = _tmp_8nxwpa_d0b0i0a0a1a2a3a8._0();
              endShape = _tmp_8nxwpa_d0b0i0a0a1a2a3a8._1();
            }
          }
        }
      ...
      EditorCell label = DiagramUtil.getCellIfNotEmpty(new Inline_Builder_wr198w_a0(editorContext, node).createCell());

      accessor.setLabelCell(label);

      editorCell.value = new EditorCell_DiagramElement(editorContext, node, accessor);
      editorCell.value.setCellId("DiagramConnector_wr198w_a");
  ...
  /*package*/ static class Inline_Builder_wr198w_a0 extends AbstractEditorBuilder {
    @NotNull
    private SNode myNode;

    /*package*/ Inline_Builder_wr198w_a0(@NotNull EditorContext context, @NotNull SNode node) {
      super(context);
      myNode = node;
    }
    ...
    private EditorCell createProperty_0() {
      ...
      try {
        final SProperty property = PROPS.etiqueta$Kcok;
