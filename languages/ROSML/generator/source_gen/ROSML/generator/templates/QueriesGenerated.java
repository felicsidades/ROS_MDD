...
public class QueriesGenerated extends QueryProviderBase {
  ...
  public static Object propertyMacro_GetValue_1_21(final PropertyMacroContext _context) {
    if (SLinkOperations.getChildren(_context.getNode(), LINKS.action_requests$xkAl).size() > 0) {
      return "callService();";
    } else {
      return "";
    }
  ...
  public static Object propertyMacro_GetValue_3_1(final PropertyMacroContext _context) {
    return "\"msg" + SPropertyOperations.getString(SLinkOperations.getTarget(SLinkOperations.getTarget(_context.getNode(), LINKS.topic$IYsG), LINKS.message$uMau), PROPS.name$MnvL) + ".msg\"";
  }
  public static Object propertyMacro_GetValue_3_2(final PropertyMacroContext _context) {
    return "\"" + SPropertyOperations.getEnum(SLinkOperations.getTarget(_context.getNode(), LINKS.message$3geB), PROPS.message_type$93N4) + "/" + SPropertyOperations.getString(SLinkOperations.getTarget(_context.getNode(), LINKS.message$3geB), PROPS.name$MnvL) + "." + SPropertyOperations.getEnum(SLinkOperations.getTarget(_context.getNode(), LINKS.message$3geB), PROPS.message_type$93N4) + "\"";
  }
  ...
  public static Object propertyMacro_GetValue_3_10(final PropertyMacroContext _context) {
    return SPropertyOperations.getString(_context.getNode(), PROPS.name$MnvL) + "/CMakeLists";
  }
  ...
  public static Object propertyMacro_GetValue_5_0(final PropertyMacroContext _context) {
    return "Datatype:" + SPropertyOperations.getString(_context.getNode(), PROPS.datatype$8ltI) + "\n";
  }
  ...
  public static Iterable<SNode> sourceNodesQuery_3_0(final SourceSubstituteMacroNodesContext _context) {
    return SLinkOperations.getChildren(_context.getNode(), LINKS.direct_connections$Xf$k);
  }
  ...
  private final Map<String, SourceNodesQuery> snsqMethods = new HashMap<String, SourceNodesQuery>();
  {
    ...
    snsqMethods.put("5823334256107632449", new SNsQ(i++));
    snsqMethods.put("5823334256107724296", new SNsQ(i++));
    ...
    snsqMethods.put("5823334256107840058", new SNsQ(i++));
    ...
    snsqMethods.put("5638402040756875785", new SNsQ(i++));
    snsqMethods.put("5638402040756938152", new SNsQ(i++));
    snsqMethods.put("5638402040756974315", new SNsQ(i++));
    snsqMethods.put("5638402040757007057", new SNsQ(i++));
    snsqMethods.put("5638402040757010379", new SNsQ(i++));
  }
  @NotNull
  @Override
  ...
  private final Map<String, PropertyValueQuery> pvqMethods = new HashMap<String, PropertyValueQuery>();
  {
    ...
    pvqMethods.put("5823334256107369376", new PVQ(i++, MetaAdapterFactory.getProperty(0xceab519525ea4f22L, 0x9b92103b95ca8c0cL, 0x110396eaaa4L, 0x110396ec041L, "name"), "node_name"));
    ...
    pvqMethods.put("1791297253455849460", new PVQ(i++, MetaAdapterFactory.getProperty(0xceab519525ea4f22L, 0x9b92103b95ca8c0cL, 0x110396eaaa4L, 0x110396ec041L, "name"), "T_publish_function_"));
    ...
    pvqMethods.put("4000481746104535373", new PVQ(i++, MetaAdapterFactory.getProperty(0xceab519525ea4f22L, 0x9b92103b95ca8c0cL, 0x110396eaaa4L, 0x110396ec041L, "name"), "callService();"));
    pvqMethods.put("4000481746104572119", new PVQ(i++, MetaAdapterFactory.getProperty(0xceab519525ea4f22L, 0x9b92103b95ca8c0cL, 0x110396eaaa4L, 0x110396ec041L, "name"), "sendActionGoal();"));
    ...
    pvqMethods.put("1911678295486526655", new PVQ(i++, MetaAdapterFactory.getProperty(0xceab519525ea4f22L, 0x9b92103b95ca8c0cL, 0x110396eaaa4L, 0x110396ec041L, "name"), "T_call_service_"));
    ...
    pvqMethods.put("5823334256107633257", new PVQ(i++, MetaAdapterFactory.getProperty(0xceab519525ea4f22L, 0x9b92103b95ca8c0cL, 0x110396eaaa4L, 0x110396ec041L, "name"), "\"msg/MessageT.msg\""));
    pvqMethods.put("5823334256107725381", new PVQ(i++, MetaAdapterFactory.getProperty(0xceab519525ea4f22L, 0x9b92103b95ca8c0cL, 0x110396eaaa4L, 0x110396ec041L, "name"), "\"msg/MessageT.msg\""));
    ...
    pvqMethods.put("5823334256107841143", new PVQ(i++, MetaAdapterFactory.getProperty(0xceab519525ea4f22L, 0x9b92103b95ca8c0cL, 0x110396eaaa4L, 0x110396ec041L, "name"), "node_name"));
    ...
    pvqMethods.put("5823334256107379950", new PVQ(i++, MetaAdapterFactory.getProperty(0xceab519525ea4f22L, 0x9b92103b95ca8c0cL, 0x110396eaaa4L, 0x110396ec041L, "name"), "node_name)"));
    ...
    pvqMethods.put("5991240145061229189", new PVQ(i++, MetaAdapterFactory.getProperty(0xceab519525ea4f22L, 0x9b92103b95ca8c0cL, 0x110396eaaa4L, 0x110396ec041L, "name"), "template_server"));
    ...
    pvqMethods.put("5638402040756907290", new PVQ(i++, MetaAdapterFactory.getProperty(0xceab519525ea4f22L, 0x9b92103b95ca8c0cL, 0x110396eaaa4L, 0x110396ec041L, "name"), "Datatype: data"));
    pvqMethods.put("5638402040756939247", new PVQ(i++, MetaAdapterFactory.getProperty(0xceab519525ea4f22L, 0x9b92103b95ca8c0cL, 0x110396eaaa4L, 0x110396ec041L, "name"), "Datatype: data"));
    ...
    pvqMethods.put("5638402040756975113", new PVQ(i++, MetaAdapterFactory.getProperty(0xceab519525ea4f22L, 0x9b92103b95ca8c0cL, 0x110396eaaa4L, 0x110396ec041L, "name"), "Datatype: data"));
    pvqMethods.put("5638402040757007046", new PVQ(i++, MetaAdapterFactory.getProperty(0xceab519525ea4f22L, 0x9b92103b95ca8c0cL, 0x110396eaaa4L, 0x110396ec041L, "name"), "Datatype: data"));
    pvqMethods.put("5638402040757010368", new PVQ(i++, MetaAdapterFactory.getProperty(0xceab519525ea4f22L, 0x9b92103b95ca8c0cL, 0x110396eaaa4L, 0x110396ec041L, "name"), "Datatype: data"));
  ...
  private static final class PROPS {
    ...
    /*package*/ static final SProperty datatype$8ltI = MetaAdapterFactory.getProperty(0xf7db56d1b41e4c13L, 0x9756a014feb108beL, 0x2126fce3999aa945L, 0x58aedddd170cb483L, "datatype");
  }
