...
<model ref="r:cd63c113-8ad3-41d4-86ef-13a5c5de1b31(ROSML.sandbox)">
  ...
  <node concept="3eGSqH" id="3u4$ffunzmZ">
    <property role="TrG5h" value="pr1" />
    <node concept="3eGSqJ" id="3u4$ffunzn0" role="SSSvX">
      <property role="TrG5h" value="n1" />
    </node>
    <node concept="37mRI7" id="3u4$ffunzn2" role="lGtFl">
      <node concept="37mRIm" id="3u4$ffunzn3" role="37mRID">
        <property role="37mO49" value="4000481746094011840" />
        <node concept="gqqVs" id="3u4$ffunzn1" role="37mO4d">
      ...
      <node concept="37mRIm" id="3u4$ffunzn7" role="37mRID">
        <property role="37mO49" value="4000481746094011844" />
        <node concept="gqqVs" id="3u4$ffunzn6" role="37mO4d">
    ...
    <node concept="3eGStl" id="3u4$ffunzn4" role="kdu6I">
      <property role="TrG5h" value="t1" />
      <node concept="1BziRk" id="3u4$ffunzn9" role="2l7YvQ">
        <property role="wLJ5w" value="true" />
        <property role="TrG5h" value="mensaje1" />
        <property role="11DesO" value="std_msgs" />
        <property role="1BziOJ" value="1zrXPLZlHDR/msg" />
        <node concept="2SJ5mA" id="3u4$ffunznb" role="1BziRl">
          <property role="1fCA_u" value="Int8" />
        </node>
      </node>
    </node>
    <node concept="3eGRtn" id="3u4$ffunzn8" role="S$65J">
      <property role="S$BzP" value="subscriber" />
      <ref role="3eGRtg" node="3u4$ffunzn0" resolve="n1" />
      <ref role="3eGRtj" node="3u4$ffunzn4" resolve="t1" />
    </node>
  </node>
</model>
